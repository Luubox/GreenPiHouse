...
function GetTempterature() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://thegreenerpihouse.azurewebsites.net/GetLatestData")
        ...
        var result = response.data.temperature + "°C";
...
function GetHumidity() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://thegreenerpihouse.azurewebsites.net/GetLatestData")
        .then(function (response) {
        console.log(response.data);
        var result = response.data.humidity + "%";
...
function GetLatest() {
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get("https://thegreenerpihouse.azurewebsites.net/GetLatestData")
        .then(function (response) {
        console.log(response.data);
        var result = "Temperatur: " + response.data.temperature + " Luftfugtighed: " + response.data.humidity;
        elementTemp.innerHTML = result;
    })
        .catch(function (error) {
        elementTemp.innerHTML = error.message;
